...
def test(name,w,N,n,e=0,ep=.65,P=1,minloc=0,maxloc=-1,directory='data/',negative=False,
	...
	cmdLine = "python orange_pipeline.py data/syn_batch_"+name+".fasta "+"data/n_genes.fasta -w "+str(w)
	...
	fout.write('test'+name+' (w='+w+', e='+e+', ep='+ep+', P='+P+')\n')
	fout.write('\t=> results: '+str(res)+'\n')
